...
function buildCharts(sample) {
  d3.json("https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json").then((data) => {
    ...
    let LayoutBubble = {
      title: 'Bacteria Count per each Sample ID',
        height: 600,
        width: 1200};
        //xaxis: {title: 'Operational Taxonomic Units (OTU) ID'},
        //yaxis: {title: 'Number of Bacteria'}

    //'bubble' is the html tag in index.html
    // Render the Bubble Chart
    Plotly.newPlot('bubble', [bubble_Trace], LayoutBubble); 
    ...
    Plotly.newPlot('bar', [bar_Trace], LayoutBar);
  });
}
